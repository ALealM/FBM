    ...
    <tbody>
      <tr>
        <td class="text-center text-danger">
          <small>$</small>{{ number_format( $fTotalCostosMateriaPrima ,2,".",",") }}
        </td>
        <td class="text-center text-danger">
        ...
        <td class="text-center text-{{ ( $fTotalGanancia - ($fCostoFijoMensual * 12) <= 0  ) ? 'danger' : 'success' }}">
          <small>$</small>{{ number_format( $fTotalGananciaReal  ,2,".",",") }}
        </td>
      </tr>
